...
window.menu = [{ text: '项目状态', img: './img/file_white.svg',
...
window.wins = new Map([['project', React.createElement(Project, null)], ['merge', React.createElement(MergeArea, null)]]);

window.popups = new Map([['task', React.createElement(Tasks, null)], ['draw', React.createElement(DrawOption, null)], ['more', React.createElement(MoreWindows, null)]]);
